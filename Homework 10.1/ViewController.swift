...
//  Homework 10.1
//
//  Created by Elias Mobrin on 5/1/20.
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var numberFav: UITextField!
    @IBOutlet weak var foodFav: UITextField!
    @IBOutlet weak var results: UITextView!
    
    
    @IBAction func saveResults(_ sender: Any) {
        let csvLine:String = "\(firstName.text!),\(lastName.text!),\(numberFav.text!),\(foodFav.text!)\n"
